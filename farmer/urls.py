...
from .views import TotalLandAreaAPIView, FarmInfoImageListCreateView, FarmInfoImageDetailView, daum_post_view
...
urlpatterns = [
    ...
    path("land/<uuid:uuid>/images/", FarmInfoImageListCreateView.as_view(), name="farminfoimage-list-create"),  # GET, POST
    path("land/<uuid:uuid>/image/", FarmInfoImageDetailView.as_view(), name="farminfoimage-delete"),  # DELETE
