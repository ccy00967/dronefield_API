...
from .views import naver_map_view
urlpatterns = [
    ...
    path("notice/<uuid:uuid>/", NoticeDetailView.as_view(),
    ...
    path("alarm/<uuid:uuid>/", AlarmDetailView.as_view(),
         name=AlarmDetailView.name),

    # path("polygon/", get_polygon_api, name="get_polygon_api"),
    path("naver_map/<uuid:uuid>/", naver_map_view, name="get_naver_map"),
]
