...
EmailRequest = openapi.Schema(
    ...
    properties={
        "email": openapi.Schema(
            "유저 이메일", type=openapi.TYPE_STRING, description="example@email.com"
        ),
    },
)
...
EmailResponse = {
        ...
        schema=openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, description="email sended"
                ),
            },
        ),
    ),
    500: openapi.Response(
        ...
        schema=openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, description="email send error"
                ),
            },
        ),
    ),
...
ValidateRequest = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        "validatekey": openapi.Schema(
            "인증번호 필요(숫자 4자리)", type=openapi.TYPE_STRING
        ),
    },
)
...
ValidateResponse = {
    200: openapi.Response(
        ...
        schema=openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, description="email validated"
                ),
            },
        ),
    ),
...
PasswordResetResponse = {
    200: openapi.Response(
        ...
        schema=openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, description="password updated"
                ),
            },
        ),
    ),
...
UserRegistrationResponse = {
        ...
        schema=openapi.Schema(
            ...
            properties={
                "success": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, description="True"
                ),
                "message": openapi.Schema(
    ...
    401: openapi.Response(
        ...
        schema=openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, description="email validation need first"
                ),
            },
        ),
    ),
